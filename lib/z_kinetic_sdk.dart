...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Z-KINETIC SDK v6.0 - ZERO-TRUST EDITION
// [+] EnvelopeValidator → TelemetryCollector (raw telemetry)
// [+] Server-side physics engine — klien hantar {x,y,t} sahaja
// [+] envelopeScore kekal sebagai fallback (backward compat)
// [+] Server buat keputusan, bukan client
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class WidgetController {
  ...
  void registerScroll(double offsetPixels) {
    // v6.0: hantar pixel offset sebenar supaya server boleh kira dy
    // Server expect perbezaan kedudukan (dy), bukan velocity
