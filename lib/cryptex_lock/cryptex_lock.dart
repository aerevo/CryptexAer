...
class _CryptexLockState extends State<CryptexLock> 
  ...
  final Color _colLocked = const Color(0xFF00FFFF);      // Pure Cyan - Sangat Terang! ✨✨✨
  ...
  final Color _colValidating = const Color(0xFF00E5FF);  // Cyan variant - Processing
  ...
  Widget _buildStateUI(SecurityState state) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: activeColor.withOpacity(0.4), // 🔧 MEGA GLOW
            blurRadius: 50,
            spreadRadius: 5,
          ),
          BoxShadow(
    ...
    return Column(
      children: [
        Icon(
          icon,
          size: 16,
          color: isGood ? color : Colors.grey[600],
        ),
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isActive
            ? [
                BoxShadow(
                  color: color.withOpacity(0.6), // 🔧 ULTRA glow untuk wheel
                  blurRadius: 30,
                  spreadRadius: 5,
                ),
              ]
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        shadows: isActive
                            ? [
                                Shadow(
                                  color: color.withOpacity(1.0), // 🔧 MAXIMUM text glow
                                  blurRadius: 20,
                                ),
                                Shadow(
