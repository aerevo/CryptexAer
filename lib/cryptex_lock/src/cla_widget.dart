...
// ============================================
// 🔥 V26.0 - PIXEL-PERFECT ALIGNMENT + LIGHT MODE 🔥
// ============================================
...
class _CryptexLockState extends State<CryptexLock> with WidgetsBindingObserver, TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF5F5F5),  // Light mode
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // 🔥 WHEELS IN RECESSED SLOT
              Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                  borderRadius: BorderRadius.circular(90),
                  boxShadow: [
                    BoxShadow(color: Colors.black.withOpacity(0.3), blurRadius: 40, spreadRadius: -20, offset: Offset(0, 15)),
                    BoxShadow(color: Colors.black.withOpacity(0.2), blurRadius: 25, spreadRadius: -12, offset: Offset(0, 10)),
                    BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 15, spreadRadius: -8, offset: Offset(0, 6)),
                  ],
                ),
                child: SizedBox(
                  height: 220,
                    ...
                    children: [
                      ...
                      Positioned.fill(
                        child: Row(
                          ...
                          children: List.generate(5, (i) => Expanded(child: _buildNumberWheel(i, activeColor))),
                        ),
                      ),
                    ],
                  ),
    ...
    return Column(
      children: [
        Icon(
          ...
          size: 22,
          color: isActive ? _successGreen : Colors.black54,
        ),
