 ...
 * MODULE: Motion Models (Pure Dart - No Flutter Dependencies)
 * PURPOSE: Cross-platform biometric data structures
 * 
 * USAGE:
 * - Flutter apps: import normally
 * - Pure Dart CLI: import as regular package
 * - Backend validators: import for verification
 */
...
class MotionEvent {
  ...
  /// Calculate euclidean distance between two events
  ...
  /// Serialize for network transmission (no PII)
...
class BiometricSession {
  ...
  /// Serialize session (no sensitive data)
  Map<String, dynamic> toJson() => {
...
/// Security states (pure enum, no Flutter)
enum SecurityState {
  LOCKED,
  VALIDATING,
  UNLOCKED,
